...
// Generated on Tue, 15 Nov 2022 18:12:11 GMT
...
public enum StyleDictionaryColor {
    ...
    public static let neutralColorsGrayDark = UIColor(red: 0.361, green: 0.361, blue: 0.361, alpha: 1)
    public static let neutralColorsGrayDisabled = UIColor(red: 0.780, green: 0.780, blue: 0.780, alpha: 1)
    public static let neutralColorsGrayLight = UIColor(red: 0.898, green: 0.898, blue: 0.898, alpha: 1)
    public static let neutralColorsWhite = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1)
    public static let primaryColorsGreen = UIColor(red: 0.133, green: 0.533, blue: 0.000, alpha: 1)
    ...
    public static let tertiaryColorsTeal = UIColor(red: 0.078, green: 0.506, blue: 0.553, alpha: 1)
    public static let tertiaryColorsTealAccent = UIColor(red: 0.412, green: 0.816, blue: 0.867, alpha: 1)
    public static let tertiaryColorsTealBackground = UIColor(red: 0.933, green: 0.984, blue: 0.988, alpha: 1)
    public static let tertiaryColorsTealDark = UIColor(red: 0.157, green: 0.384, blue: 0.443, alpha: 1)
    public static let utilityColorsRed = UIColor(red: 0.906, green: 0.000, blue: 0.000, alpha: 1)
    public static let utilityColorsRedBackground = UIColor(red: 1.000, green: 0.929, blue: 0.929, alpha: 1)
    public static let utilityColorsRedDark = UIColor(red: 0.776, green: 0.000, blue: 0.000, alpha: 1)
